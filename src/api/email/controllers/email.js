...
module.exports = createCoreController('api::email.email', ({ strapi }) => ({
  async create(ctx) {
    ...
    const { fromDate, name, email, mobileNumber, phoneNumber, company, inquiry, preferredContact, hear, country, state, message, route, date } = data;
    ...
    const emailDomain = fromDate ? 'rental@armoredautos.com' : 'sales@alpineco.com';
