...
export interface ApiApplicationAboutApplicationAbout extends Schema.SingleType {
  collectionName: 'application_abouts';
  info: {
  ...
  attributes: {
    ...
    mottoDescription: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    ourProducts: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    whoWeSellTo: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    weKnowArmoring: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    ourCertifications: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    achievementQuote: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::application-about.application-about',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiEmailEmail extends Schema.CollectionType {
  ...
  attributes: {
    ...
    representative: Attribute.String;
    importance: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::email.email',
...
export interface ApiInventoryInventory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    stock_accessories: Attribute.Component<'slices.options', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    orderSpecialOfTheMonth: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    orderSUVs: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    orderSedans: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    orderPickupTrucks: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    orderLawEnforcement: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    orderSpecialtyVehicles: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    orderPreOwned: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    orderRental: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    consignment: Attribute.Boolean &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
